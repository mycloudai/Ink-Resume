...
const i18nData = {
    ...
    translations: {
        'zh-CN': {
            ...
            confirmPrint: '确认打印',
            cancel: '取消',
            printNotice: '❗ 为了获得最佳PDF效果，请在打印目标中选择“另存为PDF”，并在“更多设置”中取消勾选“页眉和页脚”。',
            basicInfo: '基本信息',
            personalPhoto: '个人照片',
        ...
        'en-US': {
            ...
            cancel: 'Cancel',
            printNotice: '❗ For the best PDF quality, please select "Save as PDF" as the destination and uncheck "Headers and footers" in the "More settings" section.',
        ...
        'ja-JP': {
            ...
            confirmPrint: '印刷実行',
            cancel: 'キャンセル',
            printNotice: '❗ 最高のPDF品質を得るために、出力先として「PDFとして保存」を選択し、「詳細設定」で「ヘッダーとフッター」のチェックを外してください。',
            basicInfo: '基本情報',
            personalPhoto: '個人写真',
        ...
        'ko-KR': {
            ...
            confirmPrint: '인쇄 실행',
            cancel: '취소',
            printNotice: '❗ 최상의 PDF 품질을 위해 대상을 "PDF로 저장"으로 선택하고 "기타 설정"에서 "머리글 및 바닥글"을 선택 취소하십시오.',
            basicInfo: '기본 정보',
            personalPhoto: '개인 사진',
        ...
        'fr-FR': {
            ...
            cancel: 'Annuler',
            printNotice: '❗ Pour une qualité PDF optimale, veuillez sélectionner "Enregistrer en PDF" comme destination et décocher "En-têtes et pieds de page" dans la section "Plus de paramètres".',
        ...
        'de-DE': {
            ...
            cancel: 'Abbrechen',
            printNotice: '❗ Für die beste PDF-Qualität wählen Sie bitte "Als PDF speichern" als Ziel und deaktivieren Sie "Kopf- und Fußzeilen" im Abschnitt "Weitere Einstellungen".',
        ...
        'es-ES': {
            ...
            cancel: 'Cancelar',
            printNotice: '❗ Para obtener la mejor calidad de PDF, seleccione "Guardar como PDF" como destino y desmarque "Encabezados y pies de página" en la sección "Más ajustes".',
