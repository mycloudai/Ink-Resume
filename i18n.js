...
const i18nData = {
    ...
    translations: {
        'zh-CN': {
            ...
            photoUploadError: '照片处理失败',
            updatePreviewError: '预览更新失败',
        ...
        'en-US': {
            ...
            photoUploadSizeError: 'Image size cannot exceed 5MB',            photoUploadSuccess: 'Photo uploaded successfully',
            photoUploadError: 'Photo processing failed',
            updatePreviewError: 'Preview update failed',            storageDisabled: 'Browser storage is disabled (possibly in private browsing mode). Auto-save is unavailable. Please use export function to save data manually.',
        ...
        'ja-JP': {
            ...
            importInvalidFile: '有効なYAMLファイルを選択してください',
            importInvalidData: '無効なデータ形式',
            photoUploadTypeError: '画像ファイル（jpg、png、gifなど）をアップロードしてください',
            photoUploadSizeError: '画像サイズは5MBを超えることはできません',
            photoUploadSuccess: '写真がアップロードされました',
            photoUploadError: '写真の処理に失敗しました',
            updatePreviewError: 'プレビューの更新に失敗しました',
            storageDisabled: 'ブラウザストレージが無効です（プライベートブラウジングモードの可能性があります）。自動保存は利用できません。エクスポート機能を使用して手動でデータを保存してください。',
            autoSaveFailed: '自動保存に失敗しました',
            resumeNameRequired: '履歴書名を入力してください',
            restoreDataPrompt: '{time}前の自動保存データが見つかりました。復元しますか？',
        ...
        'ko-KR': {
            ...
            importInvalidFile: '유효한 YAML 파일을 선택하세요',
            importInvalidData: '잘못된 데이터 형식',
            photoUploadTypeError: '이미지 파일(jpg, png, gif 등)을 업로드하세요',
            photoUploadSizeError: '이미지 크기는 5MB를 초과할 수 없습니다',
            photoUploadSuccess: '사진이 성공적으로 업로드되었습니다',
            photoUploadError: '사진 처리에 실패했습니다',
            updatePreviewError: '미리보기 업데이트 실패',
            storageDisabled: '브라우저 저장소가 비활성화되었습니다(개인 정보 보호 모드일 수 있음). 자동 저장을 사용할 수 없습니다. 내보내기 기능을 사용하여 수동으로 데이터를 저장하세요.',
            autoSaveFailed: '자동 저장 실패',
            resumeNameRequired: '이력서 이름을 입력하세요',
            restoreDataPrompt: '{time} 전의 자동 저장 데이터를 찾았습니다. 복원하시겠습니까?',
            ...
            autoSaving: '자동 저장 중...',
            autoSaved: '저장됨',
            unsavedChanges: '저장되지 않은 변경 사항이 있습니다. 정말 나가시겠습니까?',
            // 帮助相关
            help: '도움말',
            helpTitle: '사용 가이드',
        ...
        'fr-FR': {
            ...
            importInvalidFile: 'Veuillez sélectionner un fichier YAML valide',
            importInvalidData: 'Format de données invalide',
            photoUploadTypeError: 'Veuillez télécharger un fichier image (jpg, png, gif, etc.)',
            photoUploadSizeError: 'La taille de l\'image ne peut pas dépasser 5 Mo',
            photoUploadSuccess: 'Photo téléchargée avec succès',
            photoUploadError: 'Échec du traitement de la photo',
            updatePreviewError: 'Échec de la mise à jour de l\'aperçu',
            storageDisabled: 'Le stockage du navigateur est désactivé (peut-être en mode navigation privée). La sauvegarde automatique n\'est pas disponible. Veuillez utiliser l\'exportation pour enregistrer vos données manuellement.',
            autoSaveFailed: 'Échec de la sauvegarde automatique',
            resumeNameRequired: 'Veuillez entrer le nom du CV',
            restoreDataPrompt: 'Données auto-enregistrées d\'il y a {time} trouvées. Restaurer?',
        ...
        'de-DE': {
            ...
            importInvalidFile: 'Bitte wählen Sie eine gültige YAML-Datei aus',
            importInvalidData: 'Ungültiges Datenformat',
            photoUploadTypeError: 'Bitte laden Sie eine Bilddatei hoch (jpg, png, gif usw.)',
            photoUploadSizeError: 'Die Bildgröße darf 5 MB nicht überschreiten',
            photoUploadSuccess: 'Foto erfolgreich hochgeladen',
            photoUploadError: 'Fotoverarbeitung fehlgeschlagen',
            updatePreviewError: 'Vorschau-Aktualisierung fehlgeschlagen',
            storageDisabled: 'Browser-Speicher ist deaktiviert (möglicherweise im privaten Modus). Auto-Save ist nicht verfügbar. Bitte verwenden Sie die Export-Funktion, um Ihre Daten manuell zu speichern.',
            autoSaveFailed: 'Automatisches Speichern fehlgeschlagen',
            resumeNameRequired: 'Bitte geben Sie den Lebenslauf-Namen ein',
            restoreDataPrompt: 'Automatisch gespeicherte Daten von vor {time} gefunden. Wiederherstellen?',
            ...
            unsavedChanges: 'Sie haben nicht gespeicherte Änderungen. Möchten Sie wirklich fortfahren?',
            // 帮助相关
            help: 'Hilfe',
        ...
        'es-ES': {
            ...
            importInvalidFile: 'Por favor, seleccione un archivo YAML válido',
            importInvalidData: 'Formato de datos inválido',
            photoUploadTypeError: 'Por favor, sube un archivo de imagen (jpg, png, gif, etc.)',
            photoUploadSizeError: 'El tamaño de la imagen no puede exceder 5MB',
            photoUploadSuccess: 'Foto subida con éxito',
            photoUploadError: 'Error al procesar la foto',
            updatePreviewError: 'Error al actualizar la vista previa',
            storageDisabled: 'El almacenamiento del navegador está deshabilitado (posiblemente en modo de navegación privada). El guardado automático no está disponible. Por favor, use la exportación para guardar sus datos manualmente.',
            autoSaveFailed: 'Error al guardar automáticamente',
            resumeNameRequired: 'Por favor, ingrese el nombre del currículum',
            restoreDataPrompt: 'Datos guardados automáticamente hace {time} encontrados. ¿Restaurar?',
